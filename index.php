...
<html>
 ...
 <body>
  <div id="content" style="margin-top:10px;height:100%;">
   <center><h1>Retonar todos os links de um URL</h1></center>
   <form action="index.php" method="POST">
    URL : <input name="url" size="35" placeholder="http://www.exemplo.com"/>
   ...
   if(isset($_POST['submit'])){
    $url=$_POST['url'];
    if($url==''){
     echo "<h2>Por favor digite uma URL valida.</h2>";
    }else{
